...
public class ParseMailUtil {
    ...
    public ParseMailUtil() {

    }


    public ParseMailUtil(MimeMessage mimeMessage) {
    ...
    public static void main(String args[]) throws Exception {
        ...
        ParseMailUtil re = null;


        for (int i = 0; i < message.length; i++) {

            re = new ParseMailUtil((MimeMessage) message[i]);
